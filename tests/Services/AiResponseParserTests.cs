...
public sealed class AiResponseParserTests
{
    ...
    public static IEnumerable<object?[]> StrictValidationRows()
    {
        ...
        yield return Success("more than three truncates by confidence", "{\"candidates\":[{\"type\":\"pr\",\"number\":1,\"confidence\":0.1,\"reasoning\":\"a\"},{\"type\":\"pr\",\"number\":2,\"confidence\":0.9,\"reasoning\":\"b\"},{\"type\":\"pr\",\"number\":3,\"confidence\":0.5,\"reasoning\":\"c\"},{\"type\":\"pr\",\"number\":4,\"confidence\":0.7,\"reasoning\":\"d\"},{\"type\":\"pr\",\"number\":5,\"confidence\":0.3,\"reasoning\":\"e\"}]}", 3, [0.9, 0.7, 0.5]);
