...
**If I review others' work:** Verdicts are binary — APPROVE or REJECT. Per ULTRA DIRECTIVE (Roger, 2026-05-15), there is no "APPROVE WITH NOTES" or any conditional approval. Any code-quality concern that would justify "with notes" must be raised as REJECT with the specific remedy. On REJECT, the lockout applies in full: a different agent must own the revision.
